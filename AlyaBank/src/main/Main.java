				...
				while (online) {
					...
					case 5: {
						...
						if (op1 == 1) {
							...
							System.out.println("Para pagamentos parcelados cobramos uma taxa de 3% a.m");
							System.out.println("Informe o valor do boleto:");
							double valor = sc.nextDouble();
							System.out.println("Informe o numero de parcelas:");
							int parcela = sc.nextInt();
							System.out.printf("Parcelamento de " + parcela + "x R$%.2f",((valor * (parcela * 0.03) + valor) / parcela));
							System.out.println("");
							...
							int op2 = sc.nextInt();
							if (op2 == 1) {
								if (cc[id].pagamento(valor * (parcela * 0.03) + valor)) {
									System.out.printf("Pagamento de %.2f efetuado!", valor * (parcela * 0.03) + valor);
									System.out.println("");
								} else {
									System.out.println("Não ha saldo suficiente para efetuar o saque");
								}
