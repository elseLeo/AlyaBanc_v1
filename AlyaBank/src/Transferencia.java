...
public class Transferencia {
	...
	public void transferencia() {
		...
		contabancaria.saldoDebito = contabancaria.saldoDebito - valor;
		System.out.println("Transferencia efetuadano valor de R$" + valor+ " Saldo disponivel de R$"+contabancaria.saldoDebito);
